...
{   
    ...
    for (int i = 0; i < tests; ++i)
    {
        ...
        // Exporta os tempos formatados
        cout << "Iteração " << i + 1 << ":" << endl;
        cout << "Criação de lista: " << setw(23) << times[i][0] << " ns" << endl;
        cout << "Criação de árvore: " << setw(21) << times[i][1] << " ns" << endl;
        cout << "Busca em lista: " << setw(23) << times[i][2] << " ns" << endl;
        cout << "Busca em árvore (BFS): " << setw(14) << times[i][3] << " ns" << endl;
